...
export const knownTools: SkillCardProps[] = [
    { name: "Python (Mainly Used)", level: 70, description: "I have worked on several projects in data analysis and web development, using Python as my main programming language for academic work and personal projects. This experience allowed me to deepen my understanding of Python's capabilities and apply it effectively in real-world scenarios." },
    { name: "PL/SQL (Mainly Used)", level: 75, description: "I have experience in developing databases and writing PL/SQL scripts for process automation. This work has enabled me to streamline operations and improve efficiency by automating repetitive tasks, allowing for better data management and analysis." },
    { name: "Typescript (Highly Used)", level: 55, description: "I use TypeScript in my frontend projects to enhance code quality. By leveraging its strong typing and error-checking features, I can catch potential issues early in the development process, leading to more robust and maintainable applications." },
    { name: "Javascript (Used)", level: 55, description: "I develop new features in interactive web applications using JavaScript, particularly with Node.js. This experience allows me to create dynamic server-side applications and enhance user interactions, making the overall experience more engaging and responsive." },
    { name: "FastAPI (Highly Used)", level: 60, description: "I build fast and efficient APIs with FastAPI. This framework allows me to create robust endpoints quickly, leveraging its asynchronous capabilities and automatic data validation to enhance performance and ensure reliability in my applications." },
    { name: "React.js (Highly Used)", level: 75, description: "I develop user interfaces with React, focusing on component reuse. This approach allows me to create modular and maintainable code, enhancing the overall efficiency of my projects while providing a consistent user experience across different parts of the application." },
    { name: "Docker (Used)", level: 60, description: "I use Docker for containerizing applications and services. This technology allows me to create isolated environments, ensuring consistency across development, testing, and production stages, which simplifies deployment and improves scalability." },
    { name: "Git (Mainly Used)", level: 70, description: "I manage project versions using Git. This version control system enables me to track changes, collaborate with team members, and maintain a history of modifications, ensuring a structured and efficient workflow throughout the development process." },
    { name: "Agile/Scrum (Mainly Used)", level: 70, description: "I am comfortable working in an agile and organized manner. I have participated in several teams that implemented the Scrum methodology in their daily routines to plan and execute tasks effectively." },
]
